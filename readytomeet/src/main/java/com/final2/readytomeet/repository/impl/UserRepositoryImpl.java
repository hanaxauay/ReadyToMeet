...
public class UserRepositoryImpl implements UserRepository {
    ...
    private String namespace = "com.final2.readytomeet.Mapper.UserMapper";

    /* 회원 정보 조회 - 사용자 ID 해당 하는 정보 가져오기*/
    @Override
    public UserDto readUser(String user_id){

        return sqlSession.selectOne(namespace+".readUser", user_id);
    }

    
    /* 회원정보조회 - ID, PW 정보에 해당하는 사용자 정보*/
    @Override
    public UserDto readUserWithIDPW(String user_id, String user_pw){
